...
<head>
	...
	<title>Edit Data Jenis Buku - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<form method="post" action="pro_edit_jb.php?kdjb=<?php echo $kdjb; ?>" enctype="multipart/form-data">
			<p class="h4 text-center py-4">Ubah Data Jenis Buku</p>
			<div class="md-form">
				<i class="fa fa-list-ol prefix grey-text"></i>
				<input type="text" name="namajb" placeholder="Nama Jenis Buku (JB999)" value="<?php echo $data['namajb'] ?>">
				<br><br><br>
