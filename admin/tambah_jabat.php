...
<head>
	...
	<title>Tambah Data Jabatan - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<div class="center">
			<form method="post" action="pro_tambah_jabat.php" enctype="multipart/form-data">
				<p class="h4 text-center md-5">Tambah Data Jabatan</p>
				<div class="md-form">
					<i class="fa fa-id-card-o prefix grey-text"></i>
					<input type="text" name="idjabat" placeholder="ID Jabatan (J99)" value="J" required>
				</div>
				<div class="md-form">
					<i class="fa fa-list-ol prefix grey-text"></i>
					<input type="text" name="njabat" placeholder="Nama Jabatan" required>
				</div>
				<div class="md-form">
					<i class="fa fa-list-ol prefix grey-text"></i>
