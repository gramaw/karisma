...
<head>
	...
	<title>Edit Data Jabatan - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<form method="post" action="pro_edit_jabat.php?idjabat=<?php echo $idjabat; ?>" enctype="multipart/form-data">
			<p class="h4 text-center py-4">Ubah Data Jabatan</p>
			<div class="md-form">
				<i class="fa fa-list-ol prefix grey-text"></i>
				<input type="text" name="njabat" placeholder="Nama Jabatan" value="<?php echo $data['njabat'] ?>">
			</div>
			<div class="md-form">
				<i class="fa fa-list-ol prefix grey-text"></i>
				<input type="text" name="gaji" placeholder="Gaji" value="<?php echo $data['gaji'] ?>">
			</div>
			...
			<script type='text/javascript'>
				function konfirmasi() {
					...
					if (answer){
						window.location = 'daftar_jabat.php';
					}
				}
			</script>
			<script type='text/javascript'>
