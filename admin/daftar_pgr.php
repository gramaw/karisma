...
<head>
	...
	<title>Daftar Pengarang - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="container">
	...
	<a href="tambah_pgr.php"><button class="btn btn-primary btn-sm" type="button">Tambah Data</button></a><br><br>
	<div class="card">
		<table class="table table-fixed">
			...
			<?php
			include "koneksi.php";
	$query = "SELECT * FROM pgr";
	$sql = mysqli_query($conn, $query);
	while($data = mysqli_fetch_array($sql)){
		echo "<tr>";
		echo "<td>".$data['idpgr']."</td>";
		echo "<td>".$data['npgr']."</td>";
		echo "<td>".$data['tlpgr']."</td>";
		echo "<td>".$data['umur']."</td>";
		echo "<td><a href='edit_pgr.php?idpgr=".$data['idpgr']."'><button class='btn btn-primary btn-md' type='button'><i class='fa fa-pencil'></i> Ubah </button></a></td>";
		echo "<td><a href='hapus_pgr.php?idpgr=".$data['idpgr']."'><button class='btn btn-danger btn-md' type='button'><i class='fa fa-trash-o'></i></button></a></td>";
		echo "</tr>";
	}
	?>
</table>
