...
<head>
	...
	<title>Edit Data Merk ATK - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<form method="post" action="pro_edit_merk.php?idmatk=<?php echo $idmatk; ?>" enctype="multipart/form-data">
			<p class="h4 text-center py-4">Ubah Data Merk ATK</p>
			<div class="md-form">
				<i class="fa fa-list-ol prefix grey-text"></i>
				<input type="text" name="matk" placeholder="Nama Pengarang" value="<?php echo $data['matk'] ?>">
			</div>
			<br><br><br>
