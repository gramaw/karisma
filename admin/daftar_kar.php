...
<head>
	...
	<title>Daftar Karyawan - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="container">
	...
	?>
	<h1>Data Karyawan</h1>
	<a href="tambah_kar.php"><button class="btn btn-primary btn-sm" type="button">Tambah Data</button></a><br><br>
	<div class="card">
		<table class="table table-fixed">
			...
			<?php
			include "koneksi.php";
	$query = "SELECT * FROM kar";
	$sql = mysqli_query($conn, $query);
	while($data = mysqli_fetch_array($sql)){
		echo "<tr>";
		echo "<td>".$data['idkar']."</td>";
		echo "<td>".$data['nkar']."</td>";
		echo "<td>".$data['tlkar']."</td>";
		echo "<td>".$data['ukar']."</td>";
		echo "<td>".$data['akar']."</td>";
		echo "<td>".$data['njkar']."</td>";
		echo "<td>".$data['telkar']."</td>";
		echo "<td><a href='edit_kar.php?idkar=".$data['idkar']."'><button class='btn btn-primary btn-sm' type='button'><i class='fa fa-pencil'></i>Ubah</button></a></td>";
		echo "<td><a href='hapus_kar.php?idkar=".$data['idkar']."'><button class='btn btn-danger btn-md py-3' type='button'><i class='fa fa-trash-o'></i></button></a></td>";
		echo "</tr>";
	}
	?>
</table>
