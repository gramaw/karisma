...
<head>
	...
	<title>Tambah Data Jenis ATK - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<div class="center">
			<form method="post" action="pro_tambah_jatk.php" enctype="multipart/form-data">
				<p class="h4 text-center md-5">Tambah Data Jenis ATK</p>
				<div class="md-form">
					<i class="fa fa-id-card-o prefix grey-text"></i>
					<input type="text" name="idjatk" placeholder="ID Jenis ATK (JA999)" value="JA" required>
				</div>
				<div class="md-form">
					<i class="fa fa-list-ol prefix grey-text"></i>
					<input type="text" name="jatk" placeholder="Jenis ATK" required>
				</div>
				<div class="md-form">
					<i class="fa fa-list-ol prefix grey-text"></i>
					<input type="text" name="stokjatk" placeholder="Stok" required>
				</div>
				<br><br>
	...
	<script type='text/javascript'>
		function konfirmasi() {
			...
			if (answer){
				window.location = 'daftar_jatk.php';
			}
		}
	</script>
	<script type='text/javascript'>
