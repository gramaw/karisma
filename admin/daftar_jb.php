...
<head>
	...
	<title>Daftar Jenis Buku - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="container">
	...
	<a href="tambah_jb.php"><button class="btn btn-primary btn-sm" type="button">Tambah Data</button></a><br><br>
	<div class="card">
		<table class="table table-fixed">
			...
			<?php
			include "koneksi.php";
			$query = "SELECT * FROM jenisbk";
			$sql = mysqli_query($conn, $query);
			while($data = mysqli_fetch_array($sql)){
				echo "<tr>";
				echo "<td>".$data['kdjb']."</td>";
				echo "<td>".$data['namajb']."</td>";
				echo "<td><a href='edit_jb.php?kdjb=".$data['kdjb']."'><button class='btn btn-primary btn-md' type='button'><i class='fa fa-pencil'></i> Ubah</button></a></td>";
				echo "<td><a href='hapus_jb.php?kdjb=".$data['kdjb']."'><button class='btn btn-danger btn-md' type='button'><i class='fa fa-trash-o'></i></button></a></td>";
				echo "</tr>";
			}
			?>
		</table>
