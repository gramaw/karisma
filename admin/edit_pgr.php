...
<head>
	...
	<title>Edit Data Pengarang - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<form method="post" action="pro_edit_pgr.php?idpgr=<?php echo $idpgr; ?>" enctype="multipart/form-data">
			<p class="h4 text-center py-4">Ubah Data Pengarang</p>
			<div class="md-form">
				<i class="fa fa-list-ol prefix grey-text"></i>
				<input type="text" name="npgr" placeholder="Nama Pengarang" value="<?php echo $data['npgr'] ?>">
			</div>
			<div class="md-form">
				<i class="fa fa-book prefix grey-text"></i>
				<input type="text" name="tlpgr" placeholder="Tanggal Lahir (yyyymmdd" value="<?php echo $data['tlpgr'] ?>">
			</div>
			<div class="md-form">
				<i class="fa fa-globe prefix grey-text"></i>
				<input type="text" name="umur" placeholder="Umur" value="<?php echo $data['umur'] ?>">
			</div>
			<br><br><br>
