...
<head>
	...
	<title>Tambah Data Merk ATK - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<div class="center">
			<form method="post" action="pro_tambah_merk.php" enctype="multipart/form-data">
				<p class="h4 text-center md-5">Tambah Data Merk ATK</p>
				<div class="md-form">
					<i class="fa fa-id-card-o prefix grey-text"></i>
					<input type="text" name="idmatk" placeholder="ID Merk (MA999)" value="MA" required>
				</div>
				<div class="md-form">
					<i class="fa fa-list-ol prefix grey-text"></i>
					<input type="text" name="matk" placeholder="Merk Alat Tulis Kantor" required>
				</div>
				<br><br>
	...
	<script type='text/javascript'>
		function konfirmasi() {
			...
			if (answer){
				window.location = 'daftar_merk.php';
			}
		}
	</script>
	<script type='text/javascript'>
