...
<head>
	...
	<title>Daftar Alat Tulis Kantor - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="container">
	...
	?>
	<h1>Data Alat Tulis Kantor</h1>
	<a href="tambah_atk.php"><button class="btn btn-primary btn-sm" type="button">Tambah Data</button></a><br><br>
	<div class="card">
		<table class="table table-fixed">
			...
			while($data = mysqli_fetch_array($sql)){
				echo "<td>".$data['idatk']."</td>";
				echo "<td>".$data['jatk']."</td>";
				echo "<td>".$data['matk']."</td>";
				echo "<td>".$data['stokatk']."</td>";
				echo "<td>".$data['hargaatk']."</td>";
				echo "<td><a href='edit_atk.php?idatk=".$data['idatk']."'><button class='btn btn-primary btn-md' type='button'><i class='fa fa-pencil'></i> Ubah</button></a></td>";
				echo "<td><a href='hapus_atk.php?idatk=".$data['idatk']."'><button class='btn btn-danger btn-md' type='button'><i class='fa fa-trash-o'></i></button></a></td>";
				echo "</tr>";
			}
			?>
		</table>
