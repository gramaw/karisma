...
<head>
	...
	<title>Tambah Data Jenis Buku - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<div class="center">
			<form method="post" action="pro_tambah_jb.php" enctype="multipart/form-data">
				<p class="h4 text-center md-5">Tambah Data Jenis Buku</p>
				<div class="md-form">
					<i class="fa fa-id-card-o prefix grey-text"></i>
					<input type="text" name="kdjb" placeholder="ID Jenis Buku (JB999)" value="JB" required>
				</div>
				<div class="md-form">
					<i class="fa fa-list-ol prefix grey-text"></i>
					<input type="text" name="namajb" placeholder="Jenis Buku" required>
				</div>
				<br><br>
