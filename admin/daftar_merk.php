...
<head>
	...
	<title>Daftar Merk ATK - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="container">
	...
	?>
	<h1>Data Merk ATK</h1>
	<a href="tambah_merk.php"><button class="btn btn-primary btn-sm" type="button">Tambah Data</button></a><br><br>
	<div class="card">
		<table class="table table-fixed">
			<!--judul table-->
			<tr>
				<th>ID Merk ATK</th>
				<th>Merk Alat Tulis Kantor</th>
				<th><i class='fa fa-pencil'></i> Ubah Data</th>
				<th><i class='fa fa-trash'></i> Hapus Data</th>
			</tr>
			<?php
			include "koneksi.php";
			$query = "SELECT * FROM merkatk";
			$sql = mysqli_query($conn, $query); 
			while($data = mysqli_fetch_array($sql)){ 
				echo "<tr>";
				echo "<td>".$data['idmatk']."</td>";
				echo "<td>".$data['matk']."</td>";
				echo "<td><a href='edit_merk.php?idmatk=".$data['idmatk']."'><button class='btn btn-primary btn-md' type='button'><i class='fa fa-pencil'></i> Ubah</button></a></td>";
				echo "<td><a href='hapus_merk.php?idmatk=".$data['idmatk']."'><button class='btn btn-danger btn-md' type='button'><i class='fa fa-trash-o'></i></button></a></td>";
				echo "</tr>";
			}
			?>
		</table>
