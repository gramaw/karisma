...
<head>
	...
	<title>Edit data ATK - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<form method="post" action="pro_edit_atk.php?idatk=<?php echo $idatk; ?>" enctype="multipart/form-data">
			<p class="h4 text-center py-4">Ubah Data ATK</p>
			<div class="md-form">
				<i class="fa fa-id-card-o prefix grey-text"></i>
				<input type="text" name="jatk" placeholder="Jenis Alat Tulis" value="<?php echo $data['jatk'] ?>">
			</div>
			<div class="md-form">
				<i class="fa fa-list-ol prefix grey-text"></i>
				<input type="text" name="matk" placeholder="Merk Alat Tulis" value="<?php echo $data['matk'] ?>">
			</div>
			<div class="md-form">
				<i class="fa fa-archive prefix grey-text"></i>
				<input type="text" name="stokatk" placeholder="Stok Buku" value="<?php echo $data['stokatk'] ?>">
			</div>
			<div class="md-form">
				<i class="fa fa-money prefix grey-text"></i>
				<input type="text" name="hargaatk" placeholder="Harga" value="<?php echo $data['hargaatk'] ?>">
			</div>
			<br>
			<br><br>
