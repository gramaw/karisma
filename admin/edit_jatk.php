...
<head>
	...
	<title>Edit Data Jenis ATK - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<form method="post" action="pro_edit_jatk.php?idjatk=<?php echo $idjatk; ?>" enctype="multipart/form-data">
			<p class="h4 text-center py-4">Ubah Data Jenis ATK</p>
			<div class="md-form">
				<i class="fa fa-list-ol prefix grey-text"></i>
				<input type="text" name="jatk" placeholder="Nama Jabatan" value="<?php echo $data['jatk'] ?>">
			</div>
			<div class="md-form">
				<i class="fa fa-list-ol prefix grey-text"></i>
				<input type="text" name="stokjatk" placeholder="Stok" value="<?php echo $data['stokjatk'] ?>">
			</div>
