...
<head>
	...
	<title>Tambah Data Karyawan - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="card">
	<div class="container">
		...
		?>
		<div class="center">
			<form method="post" action="pro_tambah_kar.php" enctype="multipart/form-data">
				<p class="h4 text-center md-5">Tambah Data Karyawan</p>
				<div class="md-form">
					<i class="fa fa-code prefix grey-text"></i>
					<input type="text" name="idkar" placeholder="ID Karyawan (K999)" value="K" required>
				</div>
				<div class="md-form">
					<i class="fa fa-id-card-o prefix grey-text"></i>
					<input type="text" name="nkar" placeholder="Nama Karyawan" required>
				</div>

				<div class="md-form">
					<i class="fa fa-list-ol prefix grey-text"></i>
					<input type="text" name="tlkar" placeholder="Tanggal Lahir Karyawan (yyyymmdd)" required>
				</div>
				<div class="md-form">
					<i class="fa fa-book prefix grey-text"></i>
					<input type="text" name="ukar" placeholder="Umur" required>
				</div>
				<div class="md-form">
					<i class="fa fa-globe prefix grey-text"></i>
					<input type="text" name="akar" placeholder="alamat Karyawan" required>
				</div>
				<div class="md-form">
					<i class="fa fa-sort-numeric-asc prefix grey-text"></i>
					<input type="text" name="njkar" placeholder="Jabatan Karyawan" required>
				</div>
				<div class="md-form">
					<i class="fa fa-archive prefix grey-text"></i>
					<input type="text" name="telkar" placeholder="No Telepon" required>
				</div>
				<br><br>
