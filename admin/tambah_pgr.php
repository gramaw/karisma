...
<div class="card">
	<div class="container">
		...
		?>
		<div class="center">
			<form method="post" action="pro_tambah_pgr.php" enctype="multipart/form-data">
				<p class="h4 text-center md-5">Tambah Data Pengarang</p>
				<div class="md-form">
				...
				<div class="md-form">
					...
					<input type="text" name="npgr" placeholder="Nama Pengarang" required>
				</div>
				<div class="md-form">
					<i class="fa fa-book prefix grey-text"></i>
					<input type="text" name="tlpgr" placeholder="Tanggal Lahir Pengarang (yyyymmdd)" required>
				</div>
				<div class="md-form">
