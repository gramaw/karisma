...
<head>
	...
	<title>Daftar Jabatan - Karisma</title>
	<style>
	.card {
		margin-right: auto;
		margin-left: auto;
...
<div class="container">
	...
	?>
	<h1>Data Jabatan</h1>
	<a href="tambah_jabat.php"><button class="btn btn-primary btn-sm" type="button">Tambah Data</button></a><br><br>
	<div class="card">
		<table class="table table-fixed">
			...
			<?php
			include "koneksi.php";
			$query = "SELECT * FROM jabat";
			$sql = mysqli_query($conn, $query);
			while($data = mysqli_fetch_array($sql)){
				echo "<tr>";
				echo "<td>".$data['idjabat']."</td>";
				echo "<td>".$data['njabat']."</td>";
				echo "<td>".$data['gaji']."</td>";
				echo "<td><a href='edit_jabat.php?idjabat=".$data['idjabat']."'><button class='btn btn-primary btn-md' type='button'><i class='fa fa-pencil'></i> Ubah</button></a></td>";
				echo "<td><a href='hapus_jabat.php?idjabat=".$data['idjabat']."'><button class='btn btn-danger btn-md' type='button'><i class='fa fa-trash-o'></i></button></a></td>";
				echo "</tr>";
			}
			?>
		</table>
