...
<div class="container">
	...
	?>
	<h1>Data Buku</h1>
	<a href="tambah_bk.php"><button class="btn btn-primary btn-sm" type="button">Tambah Data</button></a><br><br>
	<div class="card">
		<table class="table table-fixed">
			...
			while($data = mysqli_fetch_array($sql)){
				...
				echo "<td>".$data['kodebk']."</td>";
				echo "<td>".$data['judul']."</td>";
				echo "<td>".$data['kota']."</td>";
				echo "<td>".$data['tahun']."</td>";
				echo "<td>".$data['stokbk']."</td>";
				echo "<td>".$data['hargabk']."</td>";
				echo "<td><a href='edit_bk.php?isbn=".$data['isbn']."'><button class='btn btn-primary btn-sm' type='button'><i class='fa fa-pencil'></i> Ubah</button></a></td>";
				echo "<td><a href='hapus_bk.php?isbn=".$data['isbn']."'><button class='btn btn-danger btn-md' type='button'><i class='fa fa-trash-o'></i></button></a></td>";
				echo "</tr>";
			}
			?>
		</table>
